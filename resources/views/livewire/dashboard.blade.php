        ...
        <div class="lg:col-span-1">
            <div class="bg-white p-6 rounded-xl shadow-sm border border-gray-100 h-full">
                ...
                <div class="flex flex-col gap-4">
                    <a href="/books" class="w-full px-4 py-2 bg-indigo-600 text-white rounded-lg hover:bg-indigo-700 transition text-center font-medium">Add New Book</a>
                    <a href="/members" class="w-full px-4 py-2 border border-indigo-600 text-indigo-600 rounded-lg hover:bg-indigo-50 transition text-center font-medium">Manage Members</a>
                    <a href="/loans" class="w-full px-4 py-2 bg-gray-900 text-white rounded-lg hover:bg-black transition text-center font-medium">Register New Loan</a>
                </div>
            </div>
        </div>
    </div>
